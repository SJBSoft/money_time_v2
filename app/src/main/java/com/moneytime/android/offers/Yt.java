...
import com.moneytime.android.helper.Confetti;
...
public class Yt extends BaseAppCompat {
    ...
    private void initList() {
        ...
        youTubePlayerView.addYouTubePlayerListener(new AbstractYouTubePlayerListener() {
            ...
            @Override
            public void a(@NonNull YouTubePlayer youTubePlayer, @NonNull PlayerConstants.PlaybackQuality playbackQuality) {

            }

            @Override
            public void a(@NonNull YouTubePlayer youTubePlayer, @NonNull PlayerConstants.PlaybackRate playbackRate) {

            }

            @Override
            public void a(@NonNull YouTubePlayer youTubePlayer, @NonNull PlayerConstants.PlayerError playerError) {

            }

            @Override
            public void c(@NonNull YouTubePlayer youTubePlayer, float v) {

            }

            @Override
            public void b(@NonNull YouTubePlayer youTubePlayer, float v) {

            }

            @Override
            public void a(@NonNull YouTubePlayer youTubePlayer, float v) {

            }

            @Override
            public void a(@NonNull YouTubePlayer youTubePlayer, @NonNull String s) {
